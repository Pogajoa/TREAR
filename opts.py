...
parser.add_argument('train_list', type=str, default='/home/cvlab/바탕화면/junpyo/Trear/annotations/FPHA_train_list.txt')
parser.add_argument('--val_list', type=str, default='/home/cvlab/바탕화면/junpyo/Trear/annotations/FPHA_val_list.txt')
