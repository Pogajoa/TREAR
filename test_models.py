...
parser.add_argument('test_list', type=str, default='/home/cvlab/바탕화면/junpyo/Trear/annotations/FPHA_test_list.txt')
parser.add_argument('weights', type=str, default='./saved_model_name_appearance_model_best.pth.tar')
parser.add_argument('--arch', type=str, default="resnet50")
parser.add_argument('--save_scores', type=str, default="/home/cvlab/바탕화면/junpyo/Trear/test_result")
