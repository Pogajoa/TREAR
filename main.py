...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        save_name = '/home/cvlab/바탕화면/junpyo/Trear/train_result/' + '_'.join((args.modality.lower(), str(epoch), 'model.pth.tar'))
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    ...
    if is_best:
        ...
        best_name = '/home/cvlab/바탕화면/junpyo/Trear/train_result/' + '_'.join((args.modality.lower(), 'best.pth.tar'))
